...
class Login {
    ...
    async getMicrosoft() {
        console.log('Iniciando login premium');
    ...
    async getCrack() {
        console.log('Iniciando login no-premium.');
        let popupLogin = new popup();
        ...
        connectOffline.addEventListener('click', async () => {
            if (emailOffline.value.length < 3) {
                popupLogin.openPopup({
                    title: 'Error',
                    content: 'Tu nick no puede tener menos de 3 caracteres.',
                    options: true
                });
                return;
            }
            ...
            if (emailOffline.value.match(/ /g)) {
                popupLogin.openPopup({
                    title: 'Error',
                    content: 'Tu nick no puede contener d\'espacios.',
                    options: true
                });
                return;
            }
            ...
            if (AZauthConnect.error) {
                ...
                connectAZauthA2F.addEventListener('click', async () => {
                    ...
                    if (AZauthA2F.value == '') {
                        PopupLogin.openPopup({
                            title: 'Error',
                            content: 'Por favor ingrese el código 2FA.',
                            options: true
                        });
                        return;
                    }
